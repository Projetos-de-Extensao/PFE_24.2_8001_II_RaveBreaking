...
function ContTurismo() {
    return (
            <div>
                <img src={turismo1} alt='imagem 1 da página turismo'/>
                ...
                <img src={turismo2} alt= 'imagem 2 da página turismo'/>
                <h2 className='turismo-titulo'>Avenida Paulista</h2>
                <p className='turismo-paragraph'>Uma das avenidas mais icônicas do Brasil, a Avenida Paulista é um verdadeiro centro cultural e financeiro de São Paulo. 
