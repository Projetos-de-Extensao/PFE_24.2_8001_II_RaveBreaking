...
|Why? (Por que isso será feito?)|Para facilitar a experiências dos frquentadores do evento, tornando de fácil acesso as atrações disponíveis,localização e oque há nos arredores|
