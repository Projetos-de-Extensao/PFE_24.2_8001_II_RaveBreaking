...
|Questão|Resposta|
|-------|--------|
|What?(O que deve será feito?)|Aplicativo Web App para auxiliar frequentadores do evento  |
|Why? (Por que isso será feito?)|Para facilitar a experiências dos frquentadores do evento, tornando de fácil acesso as atrações disponíveis, localização e o que há nos arredores|
...
|How? (Como será feito?)|Utilizando metodologia RUP/UP e ferramentas como scrum, miro etc |
